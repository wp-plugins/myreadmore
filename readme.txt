...
In the <strong>myReadMore panel</strong>, you can enter the "constant" word or words you wish to use to replace the default "Read more" hyperlink. 
...
"Click and read more about <em>your-post-title</em>"
